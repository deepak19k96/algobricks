    ...
    <>
      ...
      <Box
        sx={{
          ...
          zIndex: 1100,
          backgroundImage: isMobile ? 'url("/images/navbarmobile-2.jpeg")' : 'url("/images/navbardesktop.jpeg")',
        ...
        {isMobile ? (
          ...
          <>
            ...
            <Box sx={{ textAlign: 'center' }}>
              {showIcons && (
                <Box sx={{ mb: 1 }}>
                  <IconButton onClick={() => router.push('/buildinginstruction')} sx={{ color: '#fff', mr: 2 }}>
                    <svg
                      stroke='currentColor'
                      fill='none'
                      strokeWidth='2'
